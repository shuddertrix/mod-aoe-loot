...
(@ENTRY+0, 'This server is running the |cff4CFF00AoE Loot|r module. Say .aoeloot on to enable AoE looting.', '', '', '', '', '', 'Este servidor está ejecutando el módulo |cff4CFF00AoE Loot|r.', 'Este servidor está ejecutando el módulo |cff4CFF00AoE Loot|r.', ''),
